...
const DiscussionFeed = () => {
  ...
  return (
    <Box sx={{ width: "1500%",height:"100vh",overflowY: "Scroll", display: "flex" }}>
      <div className={styles.container} style={{ backgroundColor: theme.palette.mode=="light" ? 
        "white": "#161C24"}
      }>
          ...
          <div className={styles.dropdownWrapper} ref={dropdownRef}>
            ...
            {dropdownOpen && (
              <div className={styles.dropdown}>
                <div className={styles.dropdownItem} onClick={() => navigate("/app/interviews")}>Interviews</div>
              </div>
            )}
          </div>
        </div>
          ...
          <div key={item._id} className={styles.post}>
            ...
            <div className={styles.content}>
              <div className={styles.headerLine}>
                <span className={styles.author}> {item.email
              ...
              <div
                className={`${styles.snippetLine} ${exceedsLineLimit[item._id] ? styles.blueBackground : ""
                  }`}
              >
                <span
                  ref={(el) => (messageRefs.current[item._id] = el)}
                  className={`${styles.messageText} ${!expandedMessages[item._id] && exceedsLineLimit[item._id]
